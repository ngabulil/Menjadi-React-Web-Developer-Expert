...
describe('Login spec', () => {
  ...
  it('should display alert when password is empty', () => {
    // mengisi email
    cy.get('input[placeholder="Masukkan Password"]').type('haha@email.com');
  ...
  it('should display homepage when email and password are correct', () => {
    ...
    // mengisi password
    cy.get('input[placeholder="Masukkan Password"]').type('haha123');
    ...
    cy.get('header').contains(/^EVOS LEGENDS$/).should('be.visible');
    cy.get('#profile').invoke('show')
